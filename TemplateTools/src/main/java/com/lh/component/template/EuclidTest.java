...
public class EuclidTest extends BaseTemplate {
    private IWriter mWriter;

    public EuclidTest(String dictionaryResource, String layoutResource, int numberOfPoints, IWriter writer) {
        super(dictionaryResource, layoutResource, numberOfPoints);
        this.mWriter = writer;
    }


    public EuclidTest(String layoutResource, int numberOfPoints) {
        this("vni_dic.txt", layoutResource, numberOfPoints);
    }

    public EuclidTest(String dictionaryResource, String layoutResource, int numberOfPoints) {
